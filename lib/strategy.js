...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || 'https://login.stage.tidal/authorize';
    options.tokenURL = options.tokenURL || 'https://auth-stage.tidal.com/v1/oauth2/token';
    OAuth2Strategy.call(this, options, verify);
    this.name = 'tidal';
    this._userProfileURL = options.userProfileURL || 'https://auth-stage.tidal.com/v1/user';
}
