...
function OAuth2Strategy(options, verify) {
    ...
    //       the user profile.
    this._oauth2 = new OAuth2.Oauth(options.clientID,  options.clientSecret,
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
    ...
    if (req.query && req.query.code) {
        ...
        if (state) {
            ...
            let parsed = url.parse(this._oauth2._authorizeUrl, true);
            ...
            function stored(err, state) {
                ...
                let parsed = url.parse(self._oauth2._authorizeUrl, true);
                utils.merge(parsed.query, params);
